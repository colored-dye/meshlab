...
namespace MeshDecimation
{
    ...
    void MeshDecimator::InitializePriorityQueue(QLabel *label)
    {    
    ...
    bool MeshDecimator::Decimate(QLabel *label, size_t targetNVertices, size_t targetNTriangles, double targetError)
    {
        double qem = 0.0;
        double progressOld = -1.0;
        double progress = 0.0;
        ...
        if (m_callBack)
        {
            ...
            (*m_callBack)(label, msg.str().c_str());
        }
        
        if (m_callBack) (*m_callBack)(label, "+ Initialize QEM \n");
        InitializeQEM();
        if (m_callBack) (*m_callBack)(label, "+ Initialize priority queue \n");
        InitializePriorityQueue(label);
        if (m_callBack) (*m_callBack)(label, "+ Simplification \n");
